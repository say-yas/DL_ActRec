...
echo "batch_size transformermodel doupsample lr max_length_series nhead_encoder conv1d_kernel_size bool_conv1d_emb embed_size dim_feedforward norm_type num_encoderlayers size_linear_layers accuracy f1_score gmean precision recall" > "$output_file"
