...
output_file="transformer_nodevice_segmented.txt"
outputsorted_file="transformer_nodevice_segmented_sorted.txt"

# Initialize the output file with headers
echo "batch_size transformermodel lr max_length_series segment_duration nhead_encoder conv1d_kernel_size bool_conv1d_emb embed_size dim_feedforward norm_type num_encoderlayers size_linear_layers accuracy f1_score gmean precision recall" > "$output_file"
