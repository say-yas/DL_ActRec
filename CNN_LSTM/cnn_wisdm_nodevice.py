...
try:
    ...
    if len(sys.argv) < 14:
        print("path_data/, max_length_series, num_conv_lyrs, size_linear_lyr, num_blocks_per_layer, initial_channels, lstm_hidden_size, lstm_layers, batch_size, patience, cnnlstmmodel, norm_type, lr")
    else:
        pathdata = sys.argv[1]
    ...
    run_traintest_cnnlstm.run_cnnlstm_training(padded_series, labels, class_labels,device, 
                                               ...
                                               lstm_hidden_size=lstm_hidden_size, num_lstm_layers=lstm_layers, opt="adamW", 
